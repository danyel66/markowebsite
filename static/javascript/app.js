...
category[0].onclick = function(){
    ...
    category[1].firstElementChild.setAttribute("src", "../images/goat1.png");
    category[0].firstElementChild.setAttribute("src", "../images/growth1.png");
...
category[1].onclick = function(){
    ...
    category[1].firstElementChild.setAttribute("src", "../images/goat2.png");
    category[0].firstElementChild.setAttribute("src", "../images/growth2.png");
    category[0].classList.remove('active');
    category[2].firstElementChild.setAttribute("src", "../images/services-0.png");
...
category[2].onclick = function(){
    ...
    category[0].firstElementChild.setAttribute("src", "../images/growth2.png");
    category[0].classList.remove('active');
    category[2].firstElementChild.setAttribute("src", "../images/services-1.png");
    category[2].classList.add('active');
    var prodCate = document.querySelector(".product-category").style.left ="-200%";

}

var pagination = document.getElementsByName("pag2");
var pta = document.getElementsByName("pta");
